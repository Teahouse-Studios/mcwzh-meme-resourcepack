...
def main():
    ...
    parser.add_argument('-m', '--mod-content', type=str, nargs='*', help="(Not fully implemented) Include mod strings in the path. If build type is 'all', this argument will be ignored.")
